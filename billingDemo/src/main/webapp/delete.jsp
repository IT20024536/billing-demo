...
<body>
	<h1>Delete Bill</h1>
	<form method="post" action="deleteProcessServlet">
		...
		Customer Name<input type="text" name="name" value="<%=resultSet.getString("name") %>" disabled><br>
		Phone number<input type="text" name="phone" value="<%=resultSet.getString("phone") %>" disabled><br>
